const buyerTableQueries = {
    ...
    //get Order status
    getBuyerOrderStatus: "SELECT order_status, b_name, city, fuel_station, fuel_type, fuel_price, fuel_quantity, fuel_delivery_address , b_phone_number, payment_mode FROM orders ",
